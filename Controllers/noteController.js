...
//! √
notes.post("/user/:userId/create-a-note", userAuth, async (req, res, next) => {
  try {
...
notes.get("/user/:userId",userAuth,async (req, res) => {
  const userId  = req.user.id
  try {
...
notes.get("/user/:userId/note/:noteId", userAuth, async (req, res, next) => {
  try {
...
notes.put("/user/:userId/note/:noteId",  userAuth,async (req, res, next) => {
  try {
    const { noteId, userId } = req.params;
    // const {}= req.user;
...
notes.delete("/user/:userId/note/:noteId", userAuth, async (req, res, next) => {
  try {
